...
def run_trading_strategy(portfolio_size, strategy, stock_count):
    ...
    for symbol_string in symbol_strings:
        ...
        for symbol in symbol_string.split(','):
            ...
            one_year_price_return = data[symbol]['stats']['year1ChangePercent']
            six_month_price_return = data[symbol]['stats']['month6ChangePercent']
            three_month_price_return = data[symbol]['stats']['month3ChangePercent']
            one_month_price_return = data[symbol]['stats']['month1ChangePercent']
            ...
            dataframe = dataframe.append(
                pd.Series([symbol, data[symbol]['quote']['latestPrice'], 'N/A', pe_ratio,
